<script lang="ts">
  ...
  let layout = $derived(((data.data as Record<string, unknown>)?.layout as string | undefined) || 'PageLayout');
...
<Layout {layout} data={data.data} body={data.body as string} slug={data.slug} />
